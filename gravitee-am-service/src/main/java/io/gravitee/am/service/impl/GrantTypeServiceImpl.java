...
import static io.gravitee.am.common.oauth2.GrantType.SAML2_BEARER;
...
public class GrantTypeServiceImpl implements GrantTypeService {
     ...
     */
    @Override
    public boolean isValideGrantType(List<String> grantTypes) {
        if(grantTypes==null || grantTypes.isEmpty()) {
            return false;
        }

        for(String grantType:grantTypes) {
            if(!this.isValideGrantType(grantType)) {
                return false;
            }
        }
     ...
     */
    @Override
    public boolean isValideGrantType(String grantType) {
     ...
     */
    @Override
    public void completeGrantTypeCorrespondance(Client client) {
